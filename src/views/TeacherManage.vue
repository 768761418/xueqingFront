...
<template>
  <div>
    ...
    <div style="margin-bottom: 20px;">
      <el-input v-model="params.teacher_name" style="width: 125px"
    ...
    <el-table :data="tableData" stripe>
      ...
      <el-table-column prop="teacherClass" label="班级"></el-table-column>
      <el-table-column prop="teacherSubject" label="课程"></el-table-column>
      ...
      <el-dialog title="请填写信息" :visible.sync="dialogFormVisible" width="30%">
        <el-form :model="form">
          ...
          <el-form-item label="班级" label-width="15%">
            <el-input v-model="form.teacherClass" autocomplete="off"
              style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="课程" label-width="15%">
            <el-input v-model="form.teacherSubject" autocomplete="off"
              style="width: 90%"></el-input>
          </el-form-item>
        </el-form>
    ...
    findBySearch() {
      ...
      axios({
        ...
        params: {
          ...
          value: this.params.teacher_name
        }
      }).then(res => {
        console.log(res.data.data)
        this.tableData = res.data.data.data
