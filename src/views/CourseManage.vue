...
<template>
    <div>
      ...
      <div style="margin-bottom: 20px;">
        <el-input v-model="params.name" style="width: 125px" placeholder="课程名"></el-input>
      ...
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="course_teacher" label="授课教师"></el-table-column>     
        ...
        <el-dialog title="请填写信息" :visible.sync="dialogFormVisible" width="30%">
          <el-form :model="form">
            <el-form-item label="课程ID" label-width="15%">
              <el-input v-model="form.course_id" autocomplete="off" style="width: 90%"></el-input>
            </el-form-item>
            <el-form-item label="课程名" label-width="15%">
              <el-input v-model="form.course_name" autocomplete="off" style="width: 90%"></el-input>
            </el-form-item>
            <el-form-item label="上课时间" label-width="15%">
              <el-input v-model="form.course_time" autocomplete="off" style="width: 90%"></el-input>
            </el-form-item>
            <el-form-item label="授课教师" label-width="15%">
              <el-input v-model="form.course_teacher" autocomplete="off" style="width: 90%"></el-input>
            </el-form-item>
          </el-form>
...
//   import request from '@/utils/request';
  ...
  methods: {
      ...
      //搜索
      findBySearch() {
        request.get("/admin/course/search", {
          params: this.params
        }).then(res => {
          if (res.code === '0') {
      ...
      findById() {
        request.get("/admin/course/searchbyid", {
          params: this.paramid
        }).then(res => {
          if (res.code === '0') {
            this.tableData = res.data;
