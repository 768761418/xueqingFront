<template>
  <div>
    ...
    <!-- 头部区域 -->
    <div
      style="height: 60px; line-height: 60px; background-color: white; margin-bottom: 2px;">
      <img src="@/assets/logo.png" alt=""
        style="width: 40px; position: relative; top: 10px; left: 10px;">
      ...
      <el-dropdown style="float: right;margin-right: 20px;">
        ...
        <span class="el-dropdown-link" style="color: black;font-size: 14px;">Admin<i
    ...
    <div style="display: flex;">
      <!-- 侧边栏导航 -->
      <div
        style="width: 200px; min-height: calc(100vh - 62px); height: 200px; overflow: hidden; margin-right: 2px; background-color: 2a82e4;">
        <el-menu :default-active="$route.path" router class="el-menu-demo" default
          active="1">
